                    ...
                    <ul>
                        ...
                        <li className="timeline-item">
                            <div className="timeline-content">
                                ...
                                <div className="date">2021/2026</div>
                            </div>
                        </li>
                        <li className="timeline-item">
                            <div className="timeline-content">
                            ...
                            <div className="timeline-content">
                                ...
                                <div className="description">
                                    <ul className="tasks">
                                        ...
                                        <li>Maquettage</li>
                                        <li>
                                            Gestion de l’hébergement et mise en
                                            production
                                        </li>
                                    </ul>
                                </div>
                        ...
                        <li className="timeline-item">
                            <div className="timeline-content">
                                ...
                                <div className="description">
                                    <ul className="tasks">
                                        <li>
                                            Développement fullstack Spring
                                            Boot-Angular
                                        </li>
                        ...
                        <li className="timeline-item">
                            <div className="timeline-content">
                                ...
                                <div className="description">
                                    <ul className="tasks">
                                        <li>
                                            Valorisation de l'audiovisuel à
                                        ...
                                        <li>
                                            Conception de visites virtuelles
                                            360°
                                        </li>
                                    </ul>
                                </div>
