    ...
    <>
          ...
          <div className="presentation">
            <div className="person">
              ...
              <div className="person-description">
                <p>
                  Développeur web basé à <b>Toulouse</b>, j'utilise
                  principalement <b>Symfony</b> et <b>React</b>. <br />
                  Curieux, et passionné par le <b>développement web</b>, je suis
                  en quête d’un environnement technique stimulant pour continuer
                  à apprendre et m’épanouir en équipe.
                </p>
              </div>
            </div>
      ...
      <div className="home-description">
        ...
        <div className="image-container">
          <img src={fullstackPic} alt="Image de développeur" height={"700"} />
        </div>
        <div className="fullstack-text-wrapper">
          <div className="para-container first-para">
            <p>
              Le développement <b>fullstack</b> mélange les subtils arts de la
              conception des données, de leur gestion via les bases et le{" "}
              <b>backend</b> et de leur préparation pour le <b>frontend</b>. Ce
              dernier s'occupera de les modeler à notre image, leur donner vie
              et les rendre dynamiques à travers les actions de l'utilisateur.
            </p>
          </div>
          <div className="para-container second-para">
            <p>
              Mes jouets favoris sont <b>React</b> et <b>Symfony</b>, mais les
              technologies utilisées doivent s'adapter aux projets, et le propre
              du développeur est de s'y adapter avec elles. <br />
              Ayant eu l'occasion de toucher à différentes technos, ma
              préférence se porte néanmoins sur la partie frontend.
            </p>
          </div>
        </div>
      </div>
