    ...
    return (
        <div className="tls2">
            ...
            <div className="tls2__row">
                <div className="tls2__track tls2__track--left" aria-label="Technologies row A">
                    {trackA.map((item, i) => (
                        <div className="tls-item" key={`A-${item.label}-${i}`} title={item.label}>
                            {item.src ? (
                                <img
                                    className="tls-logo"
                                    src={item.src}
            ...
            {/* Ligne 2 → droite */}
            <div className="tls2__row">
                <div className="tls2__track tls2__track--right" aria-label="Technologies row B">
                    {trackB.map((item, i) => (
                        <div className="tls-item" key={`B-${item.label}-${i}`} title={item.label}>
                            {item.src ? (
                                <img
                                    className="tls-logo"
                                    src={item.src}
